...
export const POPULAR_PRODUCTS = [
  ...
  // ----- טונה -----
  // רוב מוחלט בשמן (197) או במים (39). שני וריאנטים ברורים שמשתמשים מבחינים.
  // אבל המודאל עוד לא נבנה - לכן fallback פשוט שמכסה את כולם.
  // אזהרה: "סלט טונה" (49) - מוצר נפרד. לא מוציאים כי לעיתים זה כן מה שהמשתמש רוצה.
  {
    base:         'טונה',
    category:     'meat',
    unit:         'units',
    searchTerms:  ['טונה'],
    excludeTerms: ['לחתול', 'פאוץ'],
    defaultSize:  1,
  },
